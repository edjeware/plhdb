...
--
-- Name: plhdb_demo; Type: DATABASE; Schema: -; Owner: plhdb_admin
--

CREATE DATABASE plhdb_demo WITH TEMPLATE = template0 ENCODING = 'SQL_ASCII' LOCALE = 'C';


ALTER DATABASE plhdb_demo OWNER TO plhdb_admin;
...
--
-- Name: DATABASE plhdb_demo; Type: COMMENT; Schema: -; Owner: plhdb_admin
--

COMMENT ON DATABASE plhdb_demo IS 'A small and possibly fictional subset of sample PLHDB data made publicly accessable to demonstrate the PLHDB system.';


--
-- Name: plhdb_demo; Type: DATABASE PROPERTIES; Schema: -; Owner: plhdb_admin
--

ALTER DATABASE plhdb_demo SET "DateStyle" TO 'MDY';
ALTER DATABASE plhdb_demo SET "TimeZone" TO 'US/Eastern';
ALTER DATABASE plhdb_demo SET search_path TO 'plhdb', 'sandbox', 'demo_user';
...
--
-- Name: demo_user; Type: SCHEMA; Schema: -; Owner: plhdb_admin
--

CREATE SCHEMA demo_user;


ALTER SCHEMA demo_user OWNER TO plhdb_admin;
...
--
-- Name: DATABASE plhdb_demo; Type: ACL; Schema: -; Owner: plhdb_admin
--

REVOKE CONNECT,TEMPORARY ON DATABASE plhdb_demo FROM PUBLIC;
GRANT TEMPORARY ON DATABASE plhdb_demo TO PUBLIC;
GRANT CONNECT ON DATABASE plhdb_demo TO plhdb_managers;
GRANT CONNECT ON DATABASE plhdb_demo TO plhdb_users;
GRANT CONNECT ON DATABASE plhdb_demo TO demo_user;


--
-- Name: SCHEMA demo_user; Type: ACL; Schema: -; Owner: plhdb_admin
--

GRANT USAGE ON SCHEMA demo_user TO plhdb_managers;
GRANT USAGE ON SCHEMA demo_user TO plhdb_users;
GRANT USAGE ON SCHEMA demo_user TO demo_user;
...
GRANT SELECT ON TABLE plhdb.biography TO demo_user;
...
GRANT SELECT ON TABLE plhdb.biographies TO demo_user;
...
GRANT SELECT ON TABLE plhdb.end_event TO demo_user;
...
GRANT SELECT ON TABLE plhdb.fertility TO demo_user;
...
GRANT SELECT ON TABLE plhdb.fertilities TO demo_user;
...
GRANT SELECT ON TABLE plhdb.probability_type TO demo_user;
...
GRANT SELECT ON TABLE plhdb.site TO demo_user;
...
GRANT SELECT ON TABLE plhdb.start_event TO demo_user;
...
GRANT SELECT ON TABLE plhdb.study TO demo_user;
...
GRANT SELECT ON TABLE plhdb.taxon TO demo_user;
